...
// ✅ Sous-composant ParamsWrapper intégré
const ParamsWrapper = ({ children }: { children: (userId: string | null) => React.ReactNode }) => {
    ...
    if (selectedOption === "etudiant" || selectedOption === "universite") {
      ...
      const userData: UserData = {
        ...
        responses: {
          ...
          isOther:
            selectedOption === "simple_curieux" || selectedOption === "autre",
        },
        universityDetails: {
          universityName: "",
          universitySector: "",
      ...
      handlerSubmit(e, userData, userId);
    }
  };
